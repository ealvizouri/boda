...
export const WED_DATE_FULL = WED_DATE.format(`[${DAY_CAPITILIZED}], DD [de] [${FULL_MONTH_CAPITALIZED}] [de] YYYY`)
export const WED_DATE_NORMAL = WED_DATE.format(`DD [de] [${FULL_MONTH_CAPITALIZED}] [de] YYYY`)
export const WED_DATE_NO_YEAR = WED_DATE.format(`DD [de] [${FULL_MONTH_CAPITALIZED}]`)